...
# ========= [2] Utwórz katalogi tools/* jeśli brak =========
...
# ========= [3] Pobierz i rozpakuj źródła MariaDB =========
...
# ========= [6] Wylicz INCLUDE/LIB dla Qt pluginu =========
...
# ========= [7] Patch Qt CMakeLists.txt (jeśli nie istnieje) =========
...
# ========= [8] Przygotuj build_qt_sql_drivers od zera =========
...
# ========= [9] Konfiguracja i budowa Qt pluginu =========
...
# ========= [10] Przywrócenie CMakeLists.txt Qt =========
